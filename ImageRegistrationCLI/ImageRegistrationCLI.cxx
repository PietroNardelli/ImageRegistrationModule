...
int main( int argc, char * argv[] )
{
  ...
  /*typedef itk::DiscreteGaussianImageFilter<MovingInputImageType, MovingInputImageType> GaussianFilterType;
  typename GaussianFilterType::Pointer gaussianFilter = GaussianFilterType::New();
  gaussianFilter->SetInput( movImage );
  gaussianFilter->SetVariance(0.9);*/
